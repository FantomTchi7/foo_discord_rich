...
int main()
{
    ...
    assert( BuildCatboxCacheKey( "artist|album" ) == "catbox:artist|album" );
    assert( BuildImgurCacheKey( "artist|album" ) == "imgur:artist|album" );
    assert( BuildCatboxCacheKey( "artist|album" ) != BuildImgurCacheKey( "artist|album" ) );
    assert( BuildCatboxCacheKey( "artist|album" ) != BuildMusicBrainzCacheKey( "artist", "album", std::nullopt ) );
    assert( !BuildCatboxCacheKey( "" ) );
    ...
    assert( IsQualifiedCacheKey( "catbox:artist|album" ) );
    assert( IsQualifiedCacheKey( "imgur:artist|album" ) );
